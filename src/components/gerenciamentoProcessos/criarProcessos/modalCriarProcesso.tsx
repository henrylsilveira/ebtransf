                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="text-white">
                                <h1 className="text-2xl text-white flex justify-center items-center"><MdOutlineKeyboardDoubleArrowRight className="text-green-600 w-5 h-5" />{formData['titulo']}</h1>
                                <ul>
