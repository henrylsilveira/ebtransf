...
import { adcHab, adcMil, adcDisp, adcLocEsp, adcPermArr, ajudaCusto, reserva } from "@/utils/valores";
    ...
    return (
        <div className="max-w-4xl mx-auto shadow-container p-10 rounded-lg mb-20 mt-6">
            <div className="flex flex-1 items-center justify-center mb-6 flex-col">
                <h1 className="text-green-600 font-bold uppercase text-xl">Calculadora de Ajuda de Custo para Militares</h1>
                <p className="font-light text-white text-justify py-4">Essa calculadora tem como objetivo auxiliar o militar a calcular sua ajuda de custo de forma aproximada e não se trata de uma ferramenta oficial.</p>
            ...
            <div className="border flex flex-1 w-full flex-col border-green-600 rounded-md p-6 relative">
                ...
                <div className="grid sm:grid-cols-2 grid-cols-2 gap-4">
                    ...
                    <div className="relative z-0 w-full group">
                        ...
                        <label htmlFor="mil" className="absolute text-md text-gray-200 dark:text-gray-200 duration-300 transhtmlForm -translate-y-6 scale-75 top-3 z-10 origin-[0] peer-focus:left-0 peer-focus:text-green-600 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Adicional Militar</label>
                    </div>
                    <div className="relative z-0 w-full group">
                        <select name="disp" defaultValue=" " id="disp" onChange={(e) => handleChange(e)} className="dark:focus:bg-gray-900 leading-tight focus:bg-gray-900 block py-2.5 px-0 w-full text-md text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " required>
                            <option className="hidden"></option>
                            {adcDisp.map((adc, index) => (
                                <option key={adc + index} value={adc}>{adc}%</option>
                            ))}
                        </select>
                        <label htmlFor="disp" className="absolute text-md text-gray-200 dark:text-gray-200 duration-300 transhtmlForm -translate-y-6 scale-75 top-3 z-10 origin-[0] peer-focus:left-0 peer-focus:text-green-600 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Adicional Disp</label>
                    </div>
                    <div className="relative z-0 w-full group">
                        <select name="locEsp" id="locEsp" onChange={(e) => handleChange(e)} className="dark:focus:bg-gray-900 leading-tight focus:bg-gray-900 block py-2.5 px-0 w-full text-md text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " required>
                            <option></option>
                            {adcLocEsp.map((adc, index) => (
                                <option key={adc + index} value={adc}>{adc}%</option>
                            ))}
                        </select>
                        <label htmlFor="locEsp" className="absolute text-md text-gray-200 dark:text-gray-200 duration-300 transhtmlForm -translate-y-6 scale-75 top-3 z-10 origin-[0] peer-focus:left-0 peer-focus:text-green-600 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Adicional Loc Esp</label>
                    </div>
                    <div className="relative z-0 w-full group">
                        <select name="adcPerm" id="adcPerm" onChange={(e) => handleChange(e)} className="dark:focus:bg-gray-900 leading-tight focus:bg-gray-900 block py-2.5 px-0 w-full text-md text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " required>
                            <option></option>
                    ...
                    <div className="relative z-0  w-full group">
                        <input name="dependentes" id="dependentes" maxLength={3} defaultValue={0} onChange={(e) => handleChange(e)} className="dark:focus:bg-gray-900 leading-tight focus:bg-gray-900 block py-2.5 px-0 w-full text-md text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " />
                        <label htmlFor="dependentes" className="absolute text-md text-gray-200 dark:text-gray-200 duration-300 transhtmlForm -translate-y-6 scale-75 top-3 z-10 origin-[0] peer-focus:left-0 peer-focus:text-green-600 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Dependentes</label>

                    </div>
                    <div className="flex flex-col gap-y-6 border border-green-600 rounded-md p-4">
                        <div className="relative z-0  w-full group">
                            <select name="pgCo" id="pgCo" onChange={(e) => handleChange(e)} className="leading-tight focus:bg-gray-900 block py-2.5 px-0 w-full text-md text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none dark:focus:bg-gray-900 focus:ring-0 focus:border-green-600 peer" placeholder=" " required>
                                <option></option>
                                <option value="sdEv">SD EV</option>
                                <option value="sdEp">SD EP</option>
                                <option value="cb">CB</option>
                            ...
                            <label htmlFor="pgCo" className="absolute text-md text-gray-200 dark:text-gray-200 duration-300 transhtmlForm -translate-y-6 scale-75 top-3 z-10 origin-[0] peer-focus:left-0 peer-focus:text-green-600 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">P/G da Comp Org</label>
                        </div>
                        <div className="relative z-0  w-full group">
                            <input name="compOrg" id="compOrg" maxLength={3} defaultValue={0} onChange={(e) => handleChange(e)} className="dark:focus:bg-gray-900 leading-tight focus:bg-gray-900 block py-2.5 px-0 w-full text-md text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " />
            ...
            <div className="border border-green-600 rounded-md p-6 relative mt-8">
                ...
                <div className="border border-green-600 rounded-md p-6 relative mt-4 text-xs md:text-base">
                    ...
                    <div className="flex flex-1">
                        <b className="text-gray-300">Soldo</b><p className="pl-4 text-white">{formataValor(retornaValorSoldo(jsonData.pg)!)}</p>
                    </div>
                    <div className="flex flex-1">
                        <b className="text-gray-300">Adc Habilitação</b><p className="pl-4 text-white">{formataValor(retornaValorSoldo(jsonData.pg)! * Number(jsonData.hab) / 100)}</p>
                    </div>
                    <div className="flex flex-1">
                        <b className="text-gray-300">Adc Militar</b><p className="pl-4 text-white">{formataValor(retornaValorSoldo(jsonData.pg)! * Number(jsonData.mil) / 100)}</p>
                    </div>
                    <div className="flex flex-1">
                        <b className="text-gray-300">Adc Loc Esp</b><p className="pl-4 text-white">{formataValor(retornaValorSoldo(jsonData.pg)! * Number(jsonData.locEsp) / 100)}</p>
                    </div>
                    <div className="flex flex-1">
                        <b className="text-gray-300">Adc Disponibilidade</b><p className="pl-4 text-white">{formataValor(retornaValorSoldo(jsonData.pg)! * Number(jsonData.disp) / 100)}</p>
                    </div>
                    <div className="flex flex-1">
                        <b className="text-gray-300">Adc Compensação Orgânica</b><p className="pl-4 text-white">{formataValor(retornaValorSoldo(jsonData.pgCo)! * Number(jsonData.compOrg) / 100)}</p>
                    </div>
                    <div className="flex flex-1">
                        <b className="text-gray-300">Adc Permanência</b><p className="pl-4 text-white">{formataValor(retornaValorSoldo(jsonData.pg)! * Number(jsonData.adcPerm) / 100)}</p>
                    </div>

                    <div className="flex flex-1">
                        <b className="text-gray-300">Salário Fámilia:</b>
                        <p className="pl-2 text-white">{formataValor(jsonData.dependentes * 0.16)}</p>
                    </div>
                    <div className="flex flex-1">
