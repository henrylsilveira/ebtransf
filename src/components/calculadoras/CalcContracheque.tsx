...
export default function CalcContraChequeComponent() {
  ...
  const [decimoTerceiroPrimeira, setDecimoTerceiroPrimeira] = useState(false);
  const [decimoTerceiroSegunda, setDecimoTerceiroSegunda] = useState(false);
    ...
    <div className="max-w-2xl mx-auto shadow-container p-10 rounded-lg mb-20 mt-6">
      <div className="flex flex-1 items-center justify-center mb-6 flex-col">
        <h1 className="text-green-600 font-bold uppercase text-xl">
          Calculadora do Contracheque para Militares
        </h1>
        <p className="font-light text-white text-justify py-4">
          Essa calculadora tem como objetivo auxiliar o militar a calcular seu
          contracheque de forma aproximada e não se trata de uma ferramenta
          oficial.
        </p>
        <article className="font-light text-white text-justify py-4">
          Para calcular o contracheque militar, você geralmente precisa
          considerar o seguinte:
          <ul>
            <li>
              Soldo Base: O soldo base é o valor fundamental do salário do
              militar e varia de acordo com a graduação e o tempo de serviço.
              Quanto maior a graduação e o tempo de serviço, maior será o soldo
              base.
            </li>
            <li>
              Adicional de Habilitação: Este adicional é concedido aos militares
              que possuem qualificações específicas, como cursos de
              especialização, e varia de acordo com a habilitação adquirida.
            </li>
            <li>
              Adicional de Disponibilidae: Os militares recebem um adicional
              disponibilidade, que aumenta de acordo com o posto ou graduação.
            </li>
            <li>
              Adicional de Localidade: Militares que são designados para servir
              em locais de difícil acesso ou com alto custo de vida podem
              receber um adicional de localidade.
            </li>
            <li>
              Gratificações e Adicionais: Os militares podem ter direito a
              diferentes gratificações e adicionais, como o Adicional de
              Compensação Orgânica (ACO).
            </li>
            <li>
              Descontos: Os militares têm descontos em seus contracheques, que
              podem incluir contribuições para a Pensão Militar e Imposto de
              Renda Retido na Fonte (IRRF). Os valores desses descontos dependem
              da faixa salarial e de outros fatores individuais.
            </li>
            <li>
              Pensões e Benefícios: Em caso de morte ou invalidez do militar,
              podem ser concedidas pensões ou outros benefícios a seus
              dependentes.
            </li>
          </ul>
        </article>
      ...
      <div className="fixed left-0 bg-gray-900 backdrop-blur-sm bg-opacity-40 shadow-lg w-screen shadow-black bottom-0 p-4 z-10">
        <div className="border-2 gap-1 text-[12px] sm:text-base border-green-600 rounded p-2 flex flex-col md:flex-row items-center justify-center text-white font-bold ">
          ...
          <div className="flex boder-0 md:border-x px-2 border-green-600">
            ...
            {/* CALCULO ABAIXO ESTA APRESENTANDO VALOR ERRADO */}
            {/* <p className="font-extrabold pl-2">
              {formataValor(
                (((retornaValorSoldo(pg, anoFilter, valorReajuste)! *
                  (disp + mil + hab + adcPerm)) /
          ...
          <div className="grid sm:grid-cols-1 gap-4">
            <div className="relative z-0 w-full group">
              <select
                name="fusex"
                id="fusex"
                onChange={(e) => setFusex(Number(e.target.value))}
                className="leading-tight focus:bg-gray-900 block py-2.5 px-0 w-full text-md text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none dark:focus:bg-gray-900 focus:ring-0 focus:border-green-600 peer"
                placeholder=" "
                required
              >
              ...
              <span className="text-gray-600 text-xs">
                No caso dependente direto 3.4% e indireto 3.5%
              </span>
            </div>
            <div className="relative z-0  w-full group">
              <select
                name="pMil"
                id="pMil"
                onChange={(e) => setPMil(Number(e.target.value))}
                className="leading-tight focus:bg-gray-900 block py-2.5 px-0 w-full text-md text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none dark:focus:bg-gray-900 focus:ring-0 focus:border-green-600 peer"
                placeholder=" "
                required
              >
              ...
              <span className="text-gray-600 text-xs">
                No caso de 1.5% da filha selecionar a opção 12%
              </span>
            </div>
            <div className="relative z-0 w-full group">
              <select
            ...
            <div className="relative z-0 w-full group">
              <input
                type="number"
                onChange={(e) => setPensAlim(Number(e.target.value))}
                className="block py-2.5 [appearance:textfield] px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer"
                placeholder=" "
              />
              <label className="absolute text-sm text-gray-200 dark:text-gray-200 duration-300 transhtmlForm -translate-y-6 scale-75 top-3 z-10 origin-[0] peer-focus:left-0 peer-focus:text-green-600 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                Pensão Alimenticia
              </label>
            </div>
            <div className="relative z-0 w-full group">
      ...
      <div className="border border-green-600 rounded-md p-6 relative my-4">
        ...
        <div className="flex gap-4">
          <div className="relative z-0 w-full group grid grid-cols-1 md:grid-cols-2 items-center ">
            <FormControlLabel
              control={
                <Checkbox
                  className="text-gray-500"
                  onChange={() => setFerias(!ferias)}
                  checked={ferias}
                  color="success"
                />
              }
              label="Adicional Férias"
            ...
            <FormControlLabel
              control={
                <Checkbox
                  className="text-gray-500"
                  onChange={() =>
                    setDecimoTerceiroPrimeira(!decimoTerceiroPrimeira)
                  }
                  checked={decimoTerceiroPrimeira}
                  color="success"
                />
              }
              label="13° Salário - 1° Parcela"
              className="text-white"
            />
            <FormControlLabel
              control={
                <Checkbox
                  className="text-gray-500"
                  onChange={() =>
                    setDecimoTerceiroSegunda(!decimoTerceiroSegunda)
                  }
                  checked={decimoTerceiroSegunda}
                  color="success"
                />
              }
              label="13° Salário - 2° Parcela"
              className="text-white"
            />
          </div>
        </div>
      ...
      <div className="border border-green-600 rounded-md p-6 relative mt-4">
        ...
        <div className="border border-green-600 rounded-md p-6 relative mt-4 text-xs md:text-base">
          ...
          <div className="flex flex-1">
            ...
            <p className="pl-2 text-white">
              {formataValor(dependentes * 0.16)}
            </p>
          </div>
          {ferias && (
            <div className="flex flex-1">
              <b className="text-gray-300">Férias:</b>
              <p className="pl-4 text-white">
                {formataValor(
                  ((retornaValorSoldo(pg, anoFilter, valorReajuste)! *
                    (disp + locEsp + mil + hab + adcPerm)) /
          ...
          {decimoTerceiroPrimeira && (
            <div className="flex flex-1">
              <b className="text-gray-300">13° Salário - 1°:</b>
              <p className="pl-2 text-white">
                {formataValor(
                  ((retornaValorSoldo(pg, anoFilter, valorReajuste)! *
                    (disp + locEsp + mil + hab + adcPerm)) /
          ...
          {decimoTerceiroSegunda && (
            <div className="flex flex-1">
              <b className="text-gray-300">13° Salário - 2°:</b>
              <p className="pl-2 text-white">
                {formataValor(
                  ((retornaValorSoldo(pg, anoFilter, valorReajuste)! *
                    (disp + locEsp + mil + hab + adcPerm)) /
        ...
        <div className="border border-green-600 rounded-md p-6 relative mt-4">
          ...
          <div className="text-xs md:text-base">
            ...
            <div className="flex flex-1">
              <b className="text-gray-300">Pensão Alimentícia</b>
              <p className="pl-4 text-white">{formataValor(pensAlim)}</p>
            </div>
            {pnr === "true" ? (
        ...
        <div className="border border-green-600 rounded-md p-6 relative mt-4">
          ...
          <div className="text-xs md:text-base">
            ...
            <span className="text-xs text-gray-600 italic text-center">
              Cálculo: Valor Bruto - Descontos - (Dependentes *{" "}
              {formataValor(dependenteIR)})
            </span>
            <div className="flex flex-1">
            ...
            <span className="text-xs text-gray-600 italic text-center">
              Cálculo: (Calculo Base * Aliquota) / 100
            </span>
            <div className="flex flex-1">
            ...
            <span className="text-xs text-gray-600 italic text-center">
              Cálculo: (((Calculo Base * Aliquota) / 100) - Dedução)
            </span>
          </div>
          ...
          <article className="w-full">
            ...
            <div className="text-xs sm:text-md flex flex-col justify-center relative overflow-x-auto shadow-container sm:rounded-lg mt-4 ">
                    ...
                    <tr
                      ...
                      className={
                        calculaImpostoRenda(
                          ...
                          ? "border-b border-gray-700 !shadow-container !text-green-600 "
              ...
              <div className="py-2">
                ...
                <Link
                  href="https://www.gov.br/receitafederal/pt-br/assuntos/meu-imposto-de-renda/tabelas/2024"
                  target="_blank"
                >
                  <span className="text-xs text-gray-600 italic m-2 text-center hover:text-white">
                    Acesse: Tributação de 2024.
                  </span>
                </Link>
              </div>
            </div>
