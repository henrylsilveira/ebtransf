                ...
                <div className="flex shadow-container justify-between items-center border-gray-700 bg-gradient-to-r from-gray-800/40 to-blackA4 px-2 rounded-lg my-2 shadow-md">
                    ...
                    {loading ? <div className="w-52 h-12 flex items-center pr-4 my-2 rounded-lg py-3 justify-center border border-gray-700 bg-transparent">
                        ...
                        <div id="feedback" className="w-52 h-12 items-center flex my-2 mr-4 shadow-container">
                            <button onClick={() => handleSubmitFeedback("like")} className="shadow-container w-full flex justify-center py-3 text-white bg-gradient-to-r from-green-900/30 to-green-900 hover:bg-green-600/80 border border-green-400 rounded-l-lg"><SlLike /></button>
                            <button onClick={() => handleSubmitFeedback("dislike")} className="shadow-container w-full flex justify-center py-3 text-white  bg-gradient-to-r from-red-900/30 to-red-900 hover:bg-red-600/80 border border-red-400 rounded-r-lg"><SlDislike /></button>
                        </div>
                    }
                </div>
            )}
