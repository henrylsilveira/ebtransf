...
export default function CardFeedbackCidades({
    ...
    return (
        <Link href={`/cidades/${estado}/${cidade}/${id}`}
            ...
            className="border border-green-600 rounded-md flex justify-between flex-col relative p-6 hover:bg-gradient-to-tr from-gray-950 shadow-container to-gray-800 transition-all ease-in-out hover:border-0 hover:shadow-container">
