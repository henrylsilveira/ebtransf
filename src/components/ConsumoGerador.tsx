        ...
        <div>
            <form onSubmit={handleSubmit} className="mb-4">
                ...
                <div className="grid grid-cols-3 gap-4 mb-4">
                    ...
                    <div>
                        <div className="relative z-0 w-full group flex items-center">
                            <input type="text" name="gerador" onChange={handleChange} id="gerador" className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 dark:text-white dark:border-gray-600 [appearance:textfield] dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " required />
                    ...
                    <div>
                        <div className="relative z-0 w-full group flex items-center">
                            <input type="time" name="horaInicio" onChange={handleChange} id="horaInicio" className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 dark:text-white dark:border-gray-600 [appearance:textfield] dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " required />
                    ...
                    <div>
                        <div className="relative z-0 w-full group flex items-center">
                            <input type="time" name="horaTermino" onChange={handleChange} id="horaTermino" className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 dark:text-white dark:border-gray-600 [appearance:textfield] dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " required />
