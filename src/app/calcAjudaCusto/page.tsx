...
import CalcAjudaCustoComponent from "@/components/calculadoras/CalcAjudaCusto";
import Script from "next/script";

export default function CalcAjudaCusto() {

    return (
        <>
            <title>EBCalc - Calculadora Ajuda de Custo</title>
