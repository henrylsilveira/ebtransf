      ...
      <div className="max-w-2xl mx-auto shadow-container p-10 rounded-lg mb-20 mt-6">
        ...
        <div className="flex gap-4">
          <div className="relative z-0 mb-6 w-full group">
            <input type="date" name="primeiraData" onChange={(e) => setDateOne(e.target.value)} id="primeiraData" className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " required />
          ...
          <div className="relative z-0 mb-6 w-full group">
            <input type="date" name="segundaData" onChange={(e) => setDateTwo(e.target.value)} id="segundaData" className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " />
