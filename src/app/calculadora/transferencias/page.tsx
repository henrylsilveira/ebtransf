...
export default async function Cidades() {
    const [transferencias, setTransferencia] = useState<DadosTransferencia[]>([]);
    ...
    return (
        <>
            <title>EBCalc - Transferências</title>
            ...
            <div className="flex flex-col mx-auto max-w-4xl w-10/12 sm:text-md text-sm shadow-container p-2 sm:p-10 rounded-lg mb-20 mt-4">
                ...
                </div>
                {
                    transferencias.length === 0
                        ? <NotData textoComponent={"Não foi identificado transfêrencias salvas."} />
                        :
