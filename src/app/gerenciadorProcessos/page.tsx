...
import { MdOutlineCheckBox, MdOutlineCheckBoxOutlineBlank, MdOutlineContactSupport, MdOutlineEdit, MdOutlineKeyboardArrowDown, MdOutlineKeyboardDoubleArrowRight } from "react-icons/md";
                                    ...
                                    <ul>
                                        {processo.etapas.map((etapa, index) => (
                                            <li className="bg-gray-950 hover:bg-gradient-to-tr to-gray-950 from-gray-900/20 shadow-shape flex flex-1 rounded-md items-center mb-1 py-1 px-2 justify-between" key={index}>
                                                ...
                                                <div className="cursor-pointer" onClick={() => etapa.situacao = !etapa.situacao}>{etapa.situacao ? <MdOutlineCheckBox className="text-green-600 w-5 h-5" /> : <MdOutlineCheckBoxOutlineBlank className="text-green-600 w-5 h-5" />}</div>
                                            </li>
                                        ))}
                                    </ul>
