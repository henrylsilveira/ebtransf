    ...
    <>
      ...
      <div className="max-w-4xl mx-auto shadow-container p-10 rounded-lg mb-20 mt-6">
        ...
        <div className="flex flex-1 items-center justify-center mb-6 flex-col">
          ...
          <article>
            <div className="flex flex-1 justify-between border-b border-green-600">
              <h1
                id="#postGrad"
                className="text-green-600 font-bold uppercase pt-3  flex flex-1 items-center"
              >
              ...
              <div className="flex items-center gap-2  px-2">
                ...
                <div className="relative z-0 w-full group">
                  <select
                    ...
                    id="filteryear"
                    className="block w-28 h-6 text-sm text-white bg-gray-900 border-0 border-b-2 border-gray-300 focus:outline-none focus:ring-0 focus:border-green-600"
              ...
              <table className="w-100 sm:w-full text-left text-gray-400">
                <thead className="  uppercase text-gray-400">
                  <tr>
                    <th
                      scope="col"
                      className="px-6 py-3 bg-gray-800 text-center text-white"
                    >
                      Posto / Graduação
                    </th>
                    <th
                ...
                <tbody>
                  {dbSoldo[anoFilter as keyof typeof dbSoldo].map((postos, index) => (
                    ...
                    >
                      <th
                        scope="row"
                        className="px-6 py-4 font-medium  whitespace-nowrap  text-white bg-gray-800 flex flex-1 justify-center"
                      >
                        {postos.nome.toUpperCase()}
                      </th>
                      <td className="px-6 py-4 text-center">
                        {formataValor(postos.soldo)}
                      </td>
                    </tr>
                  ))}
                </tbody>
              ...
              <table className="w-100 sm:w-full text-left text-gray-400">
                <thead className=" uppercase text-gray-400">
                  <tr>
                    <th
                      scope="col"
                      className="px-1 sm:px-6 py-3 text-white bg-gray-800 text-center"
                    >
                      Adicional Disponibilidade
                    </th>
                    <th
                      scope="col"
                      className="px-1 sm:px-6 py-3 text-white text-center"
                    >
                      Adicional Militar
                    </th>
                    <th
